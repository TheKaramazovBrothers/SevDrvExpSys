...
//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
typedef struct  curr_cfg_opt_bits
{
    Uint32		LPF         : 1;                                                        // current reference low pass filter mask bit | 1/mask
...
//#############################################################################################################################
    tCurrCtlCfgOpt      cfg_opt;                                                        // config option for current loop control
    Uint16              tf_lpf;                                                         // low pass filter time constant | uni[us]
//#############################################################################################################################
}CURR_CTL_PRM;
...
//**************************************************************************************************************************
    double  klpf_ccmd;                                                                  // low pass filter coefficient of current reference
//**************************************************************************************************************************
